...
const mockAuditLogs: AuditLog[] = [
  {
    ...
    action: "CREATE",
    entity: "Service",
    entityName: "Soporte TÃ©cnico 24/7",
    user: "admin@example.com",
    timestamp: new Date("2025-11-02T14:30:00"),
    status: "success",
    description: "Nuevo servicio creado en el catÃ¡logo",
  },
  {
    id: "2",
    action: "UPDATE",
    entity: "Service",
    entityName: "ConsultorÃ­a Empresarial",
    user: "admin@example.com",
    timestamp: new Date("2025-11-02T13:15:00"),
    status: "success",
    description: "DescripciÃ³n y SLA actualizados",
  },
  {
    id: "3",
    action: "DELETE",
    ...
    status: "success",
    description: "Servicio eliminado del catÃ¡logo",
  },
  {
    id: "4",
    action: "UPDATE",
    entity: "Category",
    entityName: "TecnologÃ­a",
    user: "admin@example.com",
    timestamp: new Date("2025-11-01T10:20:00"),
    status: "success",
    description: "CategorÃ­a renombrada",
  },
  {
    id: "5",
    action: "CREATE",
    ...
    status: "warning",
    description: "Nueva plantilla creada (pendiente de revisiÃ³n)",
  },
]
